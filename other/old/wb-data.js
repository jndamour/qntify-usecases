// Whistleblower Claims page data

window.WB_DATA = {
  // Abstracted news clippings. Each is a short passage; 'highlights' mark
  // the index ranges (in words) that get highlighter treatment + pulse.
  clippings: [
    {
      id: 'CLIP-A',
      ...
      highlights: [
        { start: 55, end: 116 }, // "over-valuation of commodity shipments..."
        { start: 175, end: 215 },  // "twenty-two percent above market"
      ],
      tag: 'TBML',
    ...
    },
    {
      ...
      highlights: [
        { start: 50, end: 115 },   // "limited liability partnership..."
        { start: 165, end: 235 },  // "first of four six-figure transfers"
      ],
      tag: 'POL-CORR',
    ...
    },
    {
      ...
      highlights: [
        { start: 48, end: 130 },  // "service contracts were booked..."
        { start: 180, end: 240 }, // "regional controller resigned..."
      ],
      tag: 'CORP-FRAUD',
    ...
    },
    {
      ...
      highlights: [
        { start: 60, end: 145 },  // "letters of credit drawn against..."
        { start: 180, end: 245 }, // "same beneficial owner..."
      ],
      tag: 'TBML',
    ...
    },
    {
      ...
      highlights: [
        { start: 70, end: 160 }, // "consistently submitted winning bids..."
      ],
      tag: 'POL-CORR',
  ...
  // Case callout variants (tweakable)
  caseCallouts: {
    standard: {
      id: 'W-2025-047',

// Emerging Markets Financial Intelligence — page data
...
window.EM_DATA = {
  ...
  // Hero sparkline datasets. Each series is 36 monthly values.
  chartSeries: {
    fx: {
  ...
  // Correlation heatmap: 7 assets × 7 assets
  heatmap: {
    labels: ['NGN', 'GHS', 'KES', 'KZT', 'UZS', 'IDR', 'VND'],
    // symmetric matrix, values -1 to 1
    matrix: [
  ...
  // Ranked bars: entity/country exposure by sector
  rankedBars: {

...
export function TypologyGrid({ theme }) {
  const rows = WB_DATA.typologies
  return (
    <div style={{
      display: 'grid',
...
export function ProgramsTable({ theme }) {
  const programs = WB_DATA.programs
  return (
...
export function ConfidentialityBlock({ theme }) {
  const items = [

...
export function DatasetsGrid({ theme }) {
  const rows = EM_DATA.datasets
  return (
    <div style={{
...
export function Vignette({ theme }) {
  const v = EM_DATA.vignette
  return (
    <div style={{
...
export function CoverageList({ theme }) {
  const data = EM_DATA.coverage
